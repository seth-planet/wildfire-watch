# yolo8l_fire_640x640 - Multi-Size Converted Models
...
converted_models/
├── 640x640/
│   ├── yolo8l_fire_640x640_640x640.onnx
│   ├── yolo8l_fire_640x640_640x640_*.tflite
│   └── yolo8l_fire_640x640_frigate_config.yml
├── 640x480/
│   ├── yolo8l_fire_640x640_640x480.onnx
│   └── ...
├── 416x416/
│   └── ...
...
cp 320x320/yolo8l_fire_640x640_320x320_edgetpu.tflite /models/

# For Hailo-8 (high performance)
cp 640x640/yolo8l_fire_640x640_640x640_hailo8.hef /models/

# For CPU fallback
cp 416x416/yolo8l_fire_640x640_416x416_cpu.tflite /models/
```
...
```bash
cp 416x416/yolo8l_fire_640x640_frigate_config.yml /config/
```
